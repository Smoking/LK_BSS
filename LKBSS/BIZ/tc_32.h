extern "C"
{
	...
	__int16 __stdcall rf_request(HANDLE icdev,unsigned char nMode,unsigned char *tag);
	__int16 __stdcall rf_anticoll(HANDLE icdev,unsigned char *sSnr);
	__int16 __stdcall rf_select(HANDLE icdev,unsigned char *carduid,unsigned char *tag);
	...
	__int16 __stdcall rf_loadkey (HANDLE icdev,unsigned char nMode,unsigned char nSectoraddr,unsigned char *sNkey);
	__int16 __stdcall rf_authee_key (HANDLE icdev,unsigned char nMode,unsigned char nSectoraddr);
